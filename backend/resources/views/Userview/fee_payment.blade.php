         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0 font-size-18">Fee-Payment</h4>
                  ...
                  <div class="card-body pb-0 text-center">
                     ...
                     <ul class="list-group list-group-flush">
                        {{-- <li class="list-group-item d-flex px-0 justify-content-between">
                           ...
                           <span class="mb-0">{{ $fee->transaction_id }}</span>
                        </li> --}}
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           <strong>Date/Time</strong>
                           <span class="mb-0">{{ $fee->dateadd }}</span>
                        </li>
                        <li class="list-group-item d-flex px-0 justify-content-between">
                            <strong>Coin Type</strong>
                            <span class="mb-0">{{ $fee->ptype }}</span>
                         </li>
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           <strong>Amount to Pay</strong>
                           <span class="mb-0">${{ number_format($fee->fee) }}</span>
                        </li>
                     </ul>
                  </div>
            ...
            <div class="col-lg-7">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title">{{ $fee->fee_name }}</h4>
                  </div>
                  <div class="card-body">
                     <div>
                        <div>
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="text-center">
                                    ...
                                    <br>
                                    <form action="{{ route('wfee_payment_upload', ['id' => $fee->id]) }}" method="post" enctype="multipart/form-data">
                                       @csrf
                                       ...
                                       @if ($fee->status == 'unconfirmed' || $fee->status == 'canceled')
                                          <div class="mb-4" style="text-align: center;" id="circle">
                                             <br>
                                             @if ($fee->proof)
                                             <img id="blah" src="{{ url('storage/fee_payment/' . $fee->proof) }}" style="border-radius: 10%;  height: 150px;" alt="Uploaded Image">
                                             @endif
                                          </div>
